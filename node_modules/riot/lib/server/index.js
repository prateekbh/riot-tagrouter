...
require.extensions['.tag'] = function(module, filename) {
  ...
  var tag = src.substring(src.indexOf("riot.tag"));
  if( preTag && preTag.length>0){
    var tagDefination  = 'var riot = require(process.env.RIOT || "riot/riot.js");' + preTag+';module.exports ='+tag;
  }
  else{
    var tagDefination = 'var riot = require(process.env.RIOT || "riot/riot.js");module.exports =' + src;
  }
  module._compile( tagDefination , filename);
}
